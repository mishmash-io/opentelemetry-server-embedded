...
/**
 * <h2>Flattened protobuf format for OpenTelemetry signals</h2>
 * <p>
 * This package contains the classes used by the embedded OpenTelemetry
 * servers to persist 'flattened' telemetry records. Find out more about the
 * embedded servers (and how they 'flatten' OpenTelemetry data)
